...
public class PermissiveCORS extends HttpServlet {
    ...
    public void setPermissiveCORSWithRequestVariable(HttpServletResponse resp, String requestAttribute) {
        resp.setHeader("Access-Control-Allow-Origin", requestAttribute);
    }

    public void addPermissiveCORSWithRequestVariable(HttpServletResponse resp, String requestAttribute) {
        resp.addHeader("Access-Control-Allow-Origin", requestAttribute);
    }
}
